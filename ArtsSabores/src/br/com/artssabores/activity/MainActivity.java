...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (ClientFunctions.getInstance().isClienteLoggedIn(
			...
			// caso o cliente esteja logado, recupere no bando de dados o seu
			// estado
			 ...
			 * NavDrawerItem(navMenuTitles[3], navMenuIcons.getResourceId(3,
			 * -1), true, "22")); // Pages navDrawerItems.add(new
			 * NavDrawerItem(navMenuTitles[4], navMenuIcons.getResourceId(4,
			 * -1))); // What's hot, We will add a counter here
